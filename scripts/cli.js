...
const contractABI = require("../artifacts/contracts/Walletvault.sol/Walletvault.json").abi;

program
    .name("walletvault-cli")
    .description("CLI tool for Walletvault smart contract")
    .version("1.0.0");
